...
// ─── WhatsApp number read from env — NEVER hardcoded ─────────────────────────
// Falls back gracefully if the env var is not set (dev without .env).
const whatsappNumber = process.env.NEXT_PUBLIC_WHATSAPP_NUMBER ?? '';

// ─── WhatsApp SVG icon (official green brand color #25D366) ──────────────────
// lucide-react does not include a WhatsApp icon, so we use an inline SVG.
